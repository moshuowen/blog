...
import cn.mo.blog.dao.TagResponsitory;
...
public class TagServiceImpl implements TagService {
    ...
    @Autowired
    private TagResponsitory tagRepository;
    ...
    public List<Tag> listTag(String ids) {
        return tagRepository.findAllById(convertToList(ids));//接受一个list
//        这里要拿到id集合，1,2,4,5
    }
...
//        在spring2.2.1以上使用Sort.by获取Sort对象,PageRequest.of获取PageRequest对象
    ...
    public Tag updateTag(Long id, Tag tag) {
        ...
        if (t == null) {
            throw new NotFoundException("TagServiceImpl不存在该标签");
        }
