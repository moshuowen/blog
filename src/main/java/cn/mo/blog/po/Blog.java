...
public class Blog {
    ...
    public boolean isShareSatement() {
        return shareSatement;
    }

    public void setShareSatement(boolean shareSatement) {
        this.shareSatement = shareSatement;
    }
